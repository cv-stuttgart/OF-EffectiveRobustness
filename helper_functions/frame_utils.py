...
from flow_library.flow_IO import readFlowFile
...
def read_flow_sparse(filename):
    ...
    if ext == '.png':
        ...
        flow = readFlow(filename).astype(np.float32)
...
def read_gen(file_name, pil=False):
    ...
    if ext == '.png' or ext == '.jpeg' or ext == '.ppm' or ext == '.jpg':
        ...
        print(f"Unknown flow file extension {ext}")
        return []