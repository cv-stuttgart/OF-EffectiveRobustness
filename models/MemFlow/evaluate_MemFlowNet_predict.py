...
def validate_sintel(model, cfg, rank=0, estimate_model=None, estimate_cfg=None):
    ...
    for dataset_pass in ['final', "clean"]:
        ...
        print("Validation (%s) EPE: %f, EPE(s0-10): %f, EPE(s10-40): %f, EPE(s40+): %f, 1px: %f, 3px: %f, 5px: %f" %
              (dataset_pass, epe, epe_10, epe_10_40, epe_40, px1, px3, px5))
        ...
        if not use_gt:
            ...
            print(
                "Validation (%s) EPE of forward warped flow: %f, EPE(s0-10): %f, EPE(s10-40): %f, EPE(s40+): %f, 1px: %f, 3px: %f, 5px: %f" % (
                    dataset_pass, epe_forward, epe_forward_10, epe_forward_10_40, epe_forward_40, px1_forward,
    ...
    for dataset_pass in ['frames_finalpass', "frames_cleanpass"]:
        ...
        if not use_gt:
            ...
            print("Validation (%s) EPE of forward warped flow: %f, EPE(s0-10): %f, EPE(s10-40): %f, EPE(s40+): %f, 1px: %f, 3px: %f, 5px: %f" % (
                dataset_pass, epe_forward, epe_forward_10, epe_forward_10_40, epe_forward_40, px1_forward, px3_forward, px5_forward))
