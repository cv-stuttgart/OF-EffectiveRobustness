...
for dataset_pass in ['frames_cleanpass', 'frames_finalpass']:
    ...
    with open("flyingthings_"+dataset_pass+"_png.pkl", 'wb') as f:
        pickle.dump(image_list, f)
    with open("flyingthings_"+dataset_pass+"_future_pfm.pkl", 'wb') as f:
        pickle.dump(fflow_list, f)
    with open("flyingthings_"+dataset_pass+"_past_pfm.pkl", 'wb') as f:
