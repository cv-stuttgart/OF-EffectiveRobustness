    ...
    def _init_weights(self, args):
        ...
        if self.init_weight:
            ...
            if args.pretrain == 'resnet18':
                pretrained_dict = resnet18(pretrained=True  # weights=ResNet18_Weights.IMAGENET1K_V1
                                           ).state_dict()
            else:
                pretrained_dict = resnet34(pretrained=True  # weights=ResNet34_Weights.IMAGENET1K_V1
                                           ).state_dict()
