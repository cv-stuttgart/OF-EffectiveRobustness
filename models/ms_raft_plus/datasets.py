...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='sintel', dataset_pass='clean', show_extra_info=False):
        root = extention + root
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='fth', dataset_pass='frames_cleanpass'):
        root = extention + root
