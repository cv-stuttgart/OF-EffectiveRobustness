...
import os
import sys
# You might have to add the path where channelnorm_cuda-0.0.0-py3.6-linux-x86_64.egg can be found after it was compiled.
# Very likely something like /lib/pythonX.X/site-packages/
# sys.path.append("channelnorm_cuda-0.0.0-py3.6-linux-x86_64.egg")
# sys.path.append("/home/schmaljy/.local/lib/python3.6/site-packages/channelnorm_cuda-0.0.0-py3.6-linux-x86_64.egg")
